...
def config_aliengo(Cnfg: Union[Cfg, Meta]):
    ...
    _ = Cnfg.control
    _.control_type = 'P'
    _.stiffness = {'joint': 30.}  # [N*m/rad]
    _.damping = {'joint': 0.8}  # [N*m*s/rad]
